...
public class Snake {
    ...
    public Snake(Context context, int screenX, int screenY){
        ...
        bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.snake1);
        bitmap2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.snake2);
