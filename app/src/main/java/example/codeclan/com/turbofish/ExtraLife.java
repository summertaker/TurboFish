...
public class ExtraLife {
    ...
    //Enemy constructor
    public ExtraLife(Context context, int screenX, int screenY){
        ...
        bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.eat_me1);
        bitmap2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.eat_me2);
