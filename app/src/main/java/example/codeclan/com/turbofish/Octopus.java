...
public class Octopus {
    ...
    //Enemy constructor
    public Octopus(Context context, int screenX, int screenY){
        ...
        bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.octo1);
        bitmap2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.octo2);
